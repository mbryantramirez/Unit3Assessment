...
public class LoginActivity extends AppCompatActivity {
    public static final String SHAREDPREFS = "org.pursuit.unit_03_assessment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(sharedPreferences.contains("username") && sharedPreferences.contains("checkbox")){
            ...
            usernameCheckbox.setChecked(checkbox);
        }
        /*
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            if(user.equals(getResources().getString(R.string.dummy_username))
                ...
                Toast.makeText(this, getString(R.string.sign_in_toast_error_message), Toast.LENGTH_SHORT).show();
            }
